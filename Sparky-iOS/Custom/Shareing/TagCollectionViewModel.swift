...
final class TagCollectionViewModel {
    var tagList = BehaviorRelay<[Tag]>(value: [
        ...
        Tag(text: "인터뷰", backgroundColor: .sparkyOrange, buttonType: .delete),
        ...
        Tag(text: "Sparky", backgroundColor: .sparkyPink, buttonType: .delete),
        ...
        Tag(text: "창스", backgroundColor: .sparkyBlue, buttonType: .delete),
